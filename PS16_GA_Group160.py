...
class Population:
    """
    Fixed-capacity container for chromosomes with basic insert/delete
    and simple error messages for capacity and index issues.
    """
    ...
    def as_list(self):
        """Return underlying list (for iteration/zip)."""
        return self.items


# ========== Input file reader ==========

def read_input_file(filename='inputPS16.txt'):
    """
    Reads GA parameters and initial population from inputPS16.txt.
    Expected format (based on assignment sample):
    ...
    Returns:
        pop_size, chrom_length, pc, pm, generations, Population instance
    """
...
# ========== GA driver with file I/O ==========

def run_ga_from_file(input_file='inputPS16.txt',
                     output_file='outputPS16.txt',
                     seed=None):
    try:
        pop_size, chrom_length, pc, pm, generations, population = read_input_file(input_file)
...
if __name__ == "__main__":
    # Set seed for reproducibility during testing; you can remove or change it.
    population, best_history, avg_history =run_ga_from_file(input_file='inputPS16.txt',
                     output_file='outputPS16.txt',
                     seed=42)